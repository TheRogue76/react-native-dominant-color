...
public class DominantColorModule extends ReactContextBaseJavaModule {
    public static final String NAME = "DominantColor";

    public DominantColorModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    public void installLib(JavaScriptContextHolder reactContext) {
      if (reactContext.get() != 0) {
        ...
        Log.e("DominantColorModule", "JSI Runtime is not available in debug mode");
      }
    }
}
